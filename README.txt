...
a persistence unit "practico-tse-unoPersistenceUnit" which uses the JakartaEE default database.
...
In case you don't want to use JSF, simply delete this file and "src/main/webapp/beans.xml" and "src/main/java/org/example/Jsf23Activator.java"
==========================

Testing:
This sample is prepared for running unit tests with the Arquillian framework.

The configuration can be found in "practico-tse-uno/pom.xml":
...
artifacts ("practico-tse-uno-ejb.jar" and "practico-tse-uno-web.war") are already built. You can build
